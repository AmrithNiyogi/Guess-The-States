...
if __name__ == '__main__':
    ...
    screen.title("India States Game")  # Set the title of the window
    ...
    data = pd.read_csv("states.csv")  # Read the states data from the CSV file
    ...
    # Continue the game until all states are guessed
    while len(guessed_states) < 33:  # There are 33 states/union territories in India
